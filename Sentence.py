...
# Creating bigram models for brown corpus
bigram_brown_train = nltk.FreqDist(bigrams([token.lower() for token in brown.words(fileids = brown_train)]))
bigram_brown_dev = nltk.FreqDist(bigrams([token.lower() for token in brown.words(fileids = brown_dev)]))
bigram_brown_test = nltk.FreqDist(bigrams([token.lower() for token in brown.words(fileids = brown_test)]))
...
# Creating trigrammodels for Brown corpus
